...
class Visitor:
    ...
    @colony_print.visit(AstNode)
    def visit_ast_node(self, node):
        pass

    @colony_print.visit(GenericElement)
    def visit_generic_element(self, node):
        pass

    @colony_print.visit(PrintingDocument)
